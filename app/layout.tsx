...
export const metadata: Metadata = {
  ...
  category: "technology",
  description:
    "Cogerphere is an AI research lab building Openbentt (local-first research workspace), Cobentt (mobile AI chat PWA), RRbench (research verification), Meridian 0.1 (on-device research AI), context intelligence, and secure smart contracts.",
  keywords: [
    "AI research",
    "AI lab",
    "Cogerphere",
